...
namespace Training.DomainClasses
{
    public class PetShop
    {
        ...
        {
            return _petsInTheStore.GetMatching(Pet.IsSpecieOf(Species.Cat));
        }
        ...
        {
            return _petsInTheStore.GetMatching(Pet.IsSpecieOf(Species.Mouse));
        }
        ...
        {
            return _petsInTheStore.GetMatching(Pet.IsNotSpiecieOF(Species.Mouse));
        }

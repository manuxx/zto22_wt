...
namespace Training.DomainClasses
{
    public class PetShop
    {
        ...
        {
            return _petsInTheStore.GetMatching(Pet.IsSpecies(Species.Cat));
        }
        ...
        {
            return _petsInTheStore.GetMatching(Pet.IsSpecies(Species.Mouse));
        }
        ...
        {
            return _petsInTheStore.GetMatching(Pet.IsNotSpecies(Species.Mouse));
        }
